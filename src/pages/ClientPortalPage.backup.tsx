          ...
          <div className="flex justify-between items-center py-4 lg:py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm lg:text-base text-gray-600 font-medium">Bienvenue, {customer.name} ✨</p>
              </div>
            </div>
          ...
          <div className="xl:col-span-3">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 lg:p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 text-lg">Choisissez le pack qui vous convient le mieux ✨</p>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                ...
                {[
                  ...
                  { key: 'literie', label: 'Literie', emoji: '🛏️' },
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredPacks.map((pack, index) => {
                  ...
                  const categoryConfig = {
                    express: { gradient: 'from-orange-500 to-red-500', emoji: '⚡', bgGradient: 'from-orange-50 to-red-50' },
                    premium: { gradient: 'from-purple-500 to-pink-500', emoji: '💎', bgGradient: 'from-purple-50 to-pink-50' },
                    literie: { gradient: 'from-green-500 to-teal-500', emoji: '🛏️', bgGradient: 'from-green-50 to-teal-50' },
                    professionnel: { gradient: 'from-blue-500 to-indigo-500', emoji: '💼', bgGradient: 'from-blue-50 to-indigo-50' },
                    standard: { gradient: 'from-gray-500 to-gray-600', emoji: '📦', bgGradient: 'from-gray-50 to-gray-100' }
                  };
                    ...
                    >
                      ...
                      <div className="bg-white/60 rounded-xl p-4 mb-4 backdrop-blur-sm">
                        <h4 className="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                          <span className="mr-2">📋</span> Services inclus
                        </h4>
                      ...
                      <div className="flex justify-between items-end">
                        ...
                        <div className="flex flex-col items-end">
                          <button
                            ...
                            className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg ${
                              availability.available
                                ? `bg-gradient-to-r ${config.gradient} text-white hover:shadow-xl hover:shadow-${pack.category}-200`
                          ...
                          {!availability.available && (
                            <p className="text-xs text-red-600 mt-2 text-center bg-red-50 px-2 py-1 rounded-lg">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 sticky top-24">
              ...
              {currentClientAccess && clientOrders.filter(order => order.clientAccessId === currentClientAccess.id).length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-xs mt-1">Vos commandes apparaîtront ici 📦</p>
                </div>
              ) : (
                <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
                  {currentClientAccess && clientOrders
                    ...
                    .map((order, index) => {
                      const statusConfig = {
                        en_attente: { color: 'from-yellow-400 to-orange-400', icon: '⏳', bg: 'from-yellow-50 to-orange-50' },
                        en_traitement: { color: 'from-blue-400 to-indigo-400', icon: '🔄', bg: 'from-blue-50 to-indigo-50' },
                        lavage: { color: 'from-cyan-400 to-blue-400', icon: '🧼', bg: 'from-cyan-50 to-blue-50' },
                        sechage: { color: 'from-purple-400 to-pink-400', icon: '🌪️', bg: 'from-purple-50 to-pink-50' },
                        pliage: { color: 'from-pink-400 to-rose-400', icon: '👕', bg: 'from-pink-50 to-rose-50' },
                        pret: { color: 'from-green-400 to-emerald-400', icon: '✅', bg: 'from-green-50 to-emerald-50' },
                        livre: { color: 'from-gray-400 to-gray-500', icon: '📦', bg: 'from-gray-50 to-gray-100' },
                        annule: { color: 'from-red-400 to-red-500', icon: '❌', bg: 'from-red-50 to-red-100' }
                      };
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">{cart.length} article{cart.length > 1 ? 's' : ''} sélectionné{cart.length > 1 ? 's' : ''}</p>
                  </div>
                </div>
                <button
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              {cart.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 mb-6">Ajoutez des packs pour commencer vos achats 🛍️</p>
                  <button
                    onClick={() => setShowCart(false)}
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center mt-3">
                                <span className={`text-xl font-bold bg-gradient-to-r ${config.gradient} bg-clip-text text-transparent`}>
                                  {item.pack.totalPrice.toFixed(2)}€
                                </span>
                              ...
                              <div className="flex items-center gap-3">
                                <div className="text-right">
                                  <div className={`text-2xl font-bold bg-gradient-to-r ${config.gradient} bg-clip-text text-transparent`}>
                                    {(item.pack.totalPrice * item.quantity).toFixed(2)}€
                                  </div>
